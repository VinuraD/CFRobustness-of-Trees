#!/usr/bin/env python3
"""
Counterfactual Robustness Analysis (CFXplorer v3) - German Credit Dataset
...
This version uses the CFXplorer algorithm for counterfactual generation and the German Credit dataset (mixed categorical/numerical features).
...
def setup_logging():
    ...
    log_filename = f"cf_robustness_analysis_cfxplorer_v3_{timestamp}.log"
...
def create_comprehensive_visualizations(all_results, output_dir="cfxplorer_plots"):
    ...
    fig.suptitle('CFXplorer Counterfactual Data Robustness Analysis - German Credit Dataset', fontsize=16, fontweight='bold')
...
def main():
    ...
    log_print("="*80)
    log_print("COUNTERFACTUAL ROBUSTNESS ANALYSIS (CFXPLORER v3) - GERMAN CREDIT DATASET")
    log_print("="*80)
    ...
    try:
        ...
        for fold_idx in range(n_folds):
            ...
            # Save counterfactuals to CSV
            save_counterfactuals_to_csv(baseline_cf_list, "CFXplorer", "German-Credit", fold_idx, "baseline")
