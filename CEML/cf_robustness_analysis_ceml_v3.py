#!/usr/bin/env python3
"""
Counterfactual Robustness Analysis (CEML v3) - German Credit Dataset
...
The German Credit dataset contains heterogeneous features (categorical and numerical).
...
def setup_logging():
    ...
    log_filename = f"cf_robustness_analysis_ceml_v3_{timestamp}.log"
...
def prepare_german_credit_features(df):
    """
    Prepare German Credit features for CEML, handling categorical and numerical features
...
def main():
    ...
    log_print("=" * 80)
    log_print("COUNTERFACTUAL ROBUSTNESS ANALYSIS (CEML v3) - GERMAN CREDIT DATASET")
    log_print("=" * 80)
    ...
    for fold in range(5):
        ...
        try:
            ...
            continuous_features, categorical_features = prepare_german_credit_features(train_processed)
            ...
            save_counterfactuals_to_csv(cf_list, "CEML", "German-Credit", fold, "baseline")
            ...
            if not args.skip_data_perturbation:
                ...
                for bin_num in [0, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50]:
                    try:
                        ...
                        cf_metrics = calculate_comprehensive_metrics(perturbed_model, deletion_cf_list, X_test_subset, perturbed_X_train)
                ...
                # Generate CFs with 50% data using CEML
                addition_cf_list, addition_success_rate = generate_counterfactuals_ceml(
                    X_test_subset,
                    model_50pct,
                    X_train_50pct,
                    y_train_50pct
                ...
                for bin_num in [0, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50]:
                    try:
                        ...
                        cf_metrics = calculate_comprehensive_metrics(perturbed_model, addition_cf_list, X_test_subset, perturbed_X_train)
    ...
    log_print("\n" + "=" * 80)
    log_print("COUNTERFACTUAL ROBUSTNESS INSIGHTS (GERMAN CREDIT DATASET - CEML - 5 FOLDS)")
    log_print("=" * 80)
    ...
    log_print("\n🏛️ GERMAN CREDIT DATASET INSIGHTS (CEML):")
